...
def sample_tqc_params(trial: optuna.Trial,
                      ...
                      octree_batch_norm: bool = True) -> Dict[str, Any]:
    """
    Sampler for TQC hyperparameters (SAC + `top_quantiles_to_drop_per_net` param)
    """
    ...
    top_quantiles_to_drop_per_net = trial.suggest_categorical(
        "top_quantiles_to_drop_per_net", [2, 4, 8])
