...
class ExperimentManager(object):
    ...
    @staticmethod
    def is_ignition_gazebo_env(env_id: str) -> bool:
        return "gym_ignition" in gym.envs.registry.env_specs[env_id].entry_point
    ...
    #         # TODO: not sure why I need to disable this one
    ...
    # Important: Objective changed in this project (drl_grasping) to evaluate on the same environment that is used for training (cannot have two existing simulatenously with the current setup)
